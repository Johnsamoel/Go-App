...
func CreateUserHandler(service users.UserService) gin.HandlerFunc {
	return func(Context *gin.Context) {
		...
		result, err := service.CreateUserService(&newUser)
...
func DeleteUserHandler(service users.UserService) gin.HandlerFunc {
	return func(Context *gin.Context) {
...
func UpdateUserHandler(service users.UserService) gin.HandlerFunc {
	return func(Context *gin.Context) {
		// Read query parameter
		userIDStr := Context.Param("id")
		...
		err = service.UpdateUserService(userID, updateData)
		if err != nil {
...
func GetUserByIdHandler(service users.UserService) gin.HandlerFunc {
	return func(Context *gin.Context) {
		// Read query parameter
		userIDStr := Context.Param("id")
		...
		user, err := service.GetUserService(userID)
...
func LogInHandler(service users.UserService) gin.HandlerFunc {
	return func(Context *gin.Context) {
		// Read request body
		reqBody, err := ioutil.ReadAll(Context.Request.Body)
		if err != nil {
		...
		otp, err := service.LogInService(newUser.Email, newUser.Password, Context.Writer, Context.Request)
...
func LogoutHandler(service users.UserService) gin.HandlerFunc {
	return func(c *gin.Context) {
		service.LogoutService(c.Writer)
